...
MAFIAPIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://telegra.ph/file/72bb6deb3a2b5f71229e4.jpg"
)
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "TFN User"
...
USER_BOT_NO_WARN = (
    "Hello, This is **TFN Bot Ultra Private Security Protocol⚠️**.\n"
